...
class ConfigurationTests (
    ...
    @AfterAll
    fun tearDown() {
        val storageTest: String = espProp.storagePathFs
            .subSequence(0, espProp.storagePathFs.indexOf(File.separator))
            .toString()
        try {
    ...
    private fun createTestFilesFs() {
        val nameTemplate = espProp.storagePathFs + File.separator + espProp.prefFs
        try {
            Files.createDirectories(Paths.get(espProp.storagePathFs))
            ...
            File(espProp.storagePathFs + File.separator + "other_1_5_7.bin")
    ...
    private fun createTestFilesFw() {
        Files.createDirectories(Paths.get(espProp.storagePathFs))
        val nameTemplate = espProp.storagePathFw + File.separator + espProp.prefFw
        try {
            ...
            File(espProp.storagePathFw + File.separator + "other_1_7_7.bin")
